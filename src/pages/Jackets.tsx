    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-green-50/30 to-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link to="/jackets" className="text-sm font-bold text-green-600 border-b-2 border-green-600">
                Куртки
              </Link>
              <Button 
                variant="outline" 
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="animate-fade-in">
          <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-green-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent">
            Зипки и Куртки
          </h1>
          <p className="text-gray-600 text-lg mb-12">
            Стильная верхняя одежда для любой погоды
          </p>
        </div>
