...
const products = [
  ...
  {
    id: 4,
    name: 'Толстовка Sport',
    price: 4490,
    image: 'https://cdn.poehali.dev/projects/448a64db-e1e2-400c-81a1-e7988c3fb78c/files/58050c04-e256-45d0-b664-427ba9ae7c8a.jpg',
    category: 'Спорт',
    colors: ['Красный', 'Черный', 'Серый'],
    sizes: ['S', 'M', 'L', 'XL', 'XXL']
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link to="/hoodies" className="text-sm font-bold text-primary border-b-2 border-primary">
                Толстовки
              </Link>
              <Button 
                variant="outline" 
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="animate-fade-in">
          <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Толстовки и Худи
          </h1>
          <p className="text-gray-600 text-lg mb-12">
            Тепло и комфорт в стиле RealTeam
          </p>
        </div>
