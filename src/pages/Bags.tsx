...
const products = [
  ...
  {
    id: 2,
    name: 'Сумка Messenger',
    price: 2990,
    image: 'https://cdn.poehali.dev/projects/448a64db-e1e2-400c-81a1-e7988c3fb78c/files/1934b1ee-69b2-4668-b4f2-d8e0e61f6b98.jpg',
    category: 'Почтальонка',
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-red-50/30 to-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link to="/bags" className="text-sm font-bold text-red-600 border-b-2 border-red-600">
                Сумки
              </Link>
              <Button 
                variant="outline" 
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="animate-fade-in">
          <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 bg-clip-text text-transparent">
            Сумки и Рюкзаки
          </h1>
          <p className="text-gray-600 text-lg mb-12">
            Удобные аксессуары на каждый день
          </p>
        </div>
