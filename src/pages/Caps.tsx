...
const products = [
  ...
  },
  {
    ...
    image: 'https://cdn.poehali.dev/projects/448a64db-e1e2-400c-81a1-e7988c3fb78c/files/58050c04-e256-45d0-b664-427ba9ae7c8a.jpg',
    category: 'Лето',
    colors: ['Бежевый', 'Голубой', 'Розовый'],
    sizes: ['S/M', 'L/XL']
  },
  {
    id: 3,
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50/30 to-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link to="/caps" className="text-sm font-bold text-purple-600 border-b-2 border-purple-600">
                Кепки
              </Link>
              <Button 
                variant="outline" 
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="animate-fade-in">
          <h1 className="text-5xl font-bold mb-3 bg-gradient-to-r from-purple-600 via-violet-600 to-pink-600 bg-clip-text text-transparent">
            Кепки и Панамы
          </h1>
          <p className="text-gray-600 text-lg mb-12">
            Завершающий штрих для твоего образа
          </p>
        </div>
